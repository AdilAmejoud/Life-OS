        ...
        >
            ...
            >
                <div
                    ...
                    style={{ width: circle1Size, height: circle1Size, opacity: 0.9, backgroundColor: colors.circle1 }}
                />
                <div
                    className="orb-circle-2 absolute rounded-full"
                    style={{ width: circle2Size, height: circle2Size, opacity: 0.85, backgroundColor: colors.circle2 }}
                />
                <div
                    className="orb-circle-3 absolute rounded-full"
                    style={{ width: circle3Size, height: circle3Size, opacity: 0.9, backgroundColor: colors.circle3 }}
                />
                <div
                    className="orb-circle-4 absolute rounded-full"
                    style={{ width: circle4Size, height: circle4Size, opacity: 0.8, backgroundColor: colors.circle4 }}
                />
                <div
                    className="orb-circle-5 absolute rounded-full"
                    style={{ width: circle5Size, height: circle5Size, opacity: 0.85, backgroundColor: colors.circle5 }}
                />
            </div>
